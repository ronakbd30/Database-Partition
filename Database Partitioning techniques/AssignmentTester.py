...
#
__author__ = 'Sudhashree'

DATABASE_NAME = 'sudha_dds_assgn1'

# TODO: Change these as per your code
RATINGS_TABLE = 'ratings'
RANGE_TABLE_PREFIX = 'ratingsrange'
RROBIN_TABLE_PREFIX = 'ratingsrr'
USER_ID_COLNAME = 'userid'
MOVIE_ID_COLNAME = 'movieid'
RATING_COLNAME = 'rating'
INPUT_FILE_PATH = 'C:\Users\Sud\Desktop\Sem3\DDS\Assignments\\test_data.dat'
...
def getopenconnection(user='postgres', password='klmn4321', dbname='sudha_dds_assgn1'):
