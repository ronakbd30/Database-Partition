...
def getOpenConnection(user='postgres', password='ronak', dbname='ddsassignment2'):
...
def rangePartition(ratingstablename, numberofpartitions, openconnection):
    ...
    try:
        ...
        if not bool(cursor.rowcount):
            ...
            return
        cursor.execute("CREATE TABLE RangeRatingsMetadata(PartitionNum INT, MinRating REAL, MaxRating REAL)")
        MinRating = 0.0
        MaxRating = 5.0
...
def roundRobinPartition(ratingstablename, numberofpartitions, openconnection):
    ...
    try:
        ...
        if not bool(cursor.rowcount):
            print "Please Load Ratings Table first!!!"
            return
        cursor.execute("CREATE TABLE RoundRobinRatingsMetadata(PartitionNum INT, TableNextInsert INT)")
        x = 0
